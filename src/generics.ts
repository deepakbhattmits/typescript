...
const createCourseGoal = (title:string, description:string, date:Date):CourseGoal =>
{
    ...
    courseGoal.title = 'Deepak';
    courseGoal.description= 'Software Developer';
    courseGoal.date = new Date();
    return courseGoal as CourseGoal
}

const names:Readonly<string[]> = ['Deepak', 'Puji'];


// If we do this push operation to readonly then TS yell this to us
